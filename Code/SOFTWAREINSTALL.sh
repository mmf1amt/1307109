...
yum install htop  >> /var/log/GitLogging.log
...
sudo yum install htop  >> /var/log/GitLogging.log
...
yum install git >> /var/log/GitLogging.log
...
sudo yum install git >> /var/log/GitLogging.log
